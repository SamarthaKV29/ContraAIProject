...
// RandomAgent Class									
//-----------------------------------------------------
class RandomAgent: public ObjectBase
{

public:
	
	RandomAgent( int x, int y, bool AIAgent);	// Constructor
	virtual ~RandomAgent();		// Destructor
...
private: 
	...
	// assignment operator.
	// -------------------------
	RandomAgent(const RandomAgent& yRef);									
	RandomAgent& operator=(const RandomAgent& yRef);	
};